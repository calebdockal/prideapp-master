...
import { updateField, updateImages, deleteImage } from '../../actions/businessAction'
import DropDownPicker from 'react-native-dropdown-picker';
import AntIcon from "react-native-vector-icons/AntDesign";
import EntypoIcon from "react-native-vector-icons/Entypo";
import ImagePicker from 'react-native-image-picker';

function BusinessOwnerAdd1(props) {
  ...
  return (
    <View style={styles.container}>
      <ScrollView horizontal={true} style={styles.images} contentContainerStyle={styles.contentContainerStyle}>
        ...
        { props.business.images && props.business.images.map((res, id) => (
          <View key={(res.uri ? res.uri : res)+id} style={styles.imagesContainer}>
            <Image 
              source={{uri: res.uri ? res.uri : res}}
      ...
      <View style={styles.form}>
        <View>
          ...
          <View style={styles.field}>
            <TextInput style={styles.input} autoFocus={true} returnKeyType={'next'} onSubmitEditing={() => detailsRef.current.focus()} autoCapitalize="none" onChangeText={businessName => props.updateField({businessName})} value={props.business.businessName} />
          </View>
        </View>
        <View style={{marginTop: 10}}>
          ...
          <View style={styles.field}>
            <DropDownPicker
              ...
              searchable={true}
              defaultValue={props.business.category ? props.business.category : ''}
        ...
        <View style={{marginTop: 10}}>
          ...
          <View style={styles.field}>
            <TextInput 
              ...
              value={props.business.details}
            />
          </View>
        </View>
      </View>
      <TouchableOpacity style={styles.nextBtn} onPress={() => props.navigation.navigate("BusinessOwnerAdd2")}>
