...
import { loadBusinessList, loadSavedList } from '../../actions/userAction'
        ...
        { props.isLoading ? (
          ...
          <View>
            {props.business.list ? props.business.list.map(item => {
              ...
              return (
                <TouchableOpacity key={item._id} style={styles.item} onPress={() => navigateTo(item)}>
...
const mapDispatchToProps = dispatch => {
	return bindActionCreators({ loadBusinessList, load, loadSavedList }, dispatch)
}
